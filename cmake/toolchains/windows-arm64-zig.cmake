...
# Toolchain file for cross-compiling to Windows ARM64 using Zig
#
# Uses MinGW ABI (windows-gnu) which doesn't require Windows SDK.
# Produces .exe and .lib files that run on Windows ARM64.
#
# Prerequisites:
#   - Install Zig: https://ziglang.org/download/
#
# Usage:
#   cmake -B build-windows-arm64 \
#     -DCMAKE_TOOLCHAIN_FILE=cmake/toolchains/windows-arm64-zig.cmake
...
set(CMAKE_C_COMPILER "${_zig_wrapper_dir}/zig-cc-aarch64-windows-gnu")
set(CMAKE_CXX_COMPILER "${_zig_wrapper_dir}/zig-cxx-aarch64-windows-gnu")
