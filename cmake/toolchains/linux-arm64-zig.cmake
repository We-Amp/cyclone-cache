...
# Toolchain file for cross-compiling to Linux ARM64 using Zig
#
# Zig is an excellent cross-compiler that bundles libc for many platforms.
# This allows cross-compiling from any host (macOS, Windows, Linux) to Linux ARM64.
#
# Prerequisites:
...
#     -DCMAKE_TOOLCHAIN_FILE=cmake/toolchains/linux-arm64-zig.cmake \
#     -DOPENSSL_ROOT_DIR=/path/to/openssl-linux-arm64
#
...
set(CMAKE_C_COMPILER "${_zig_wrapper_dir}/zig-cc-aarch64-linux-musl")
set(CMAKE_CXX_COMPILER "${_zig_wrapper_dir}/zig-cxx-aarch64-linux-musl")
